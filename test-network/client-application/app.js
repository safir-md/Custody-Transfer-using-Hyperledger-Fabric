...
async function main() {
	try {
		...
		try {
			...
			result = await contract.submitTransaction('CreateAsset', 'asset5', 'Australia', 'Woodside Energy', '2500', '3.57','Australia');
			...
			console.log('\n--> Submit Transaction: UpdateAsset asset1, change the Volume to 2500');
			await contract.submitTransaction('UpdateAsset', 'asset1', 'Germany', 'Eni', '2500', '5.58', 'Germany');
			console.log('*** Result: committed');
